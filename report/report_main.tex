...
\usepackage[firstinits=true,backend=biber,maxbibnames=5]{biblatex}
%\usepackage{cite}
...
pdftitle = {Modelling and verifying the PIP protokernel in a deep embedding of C},	% Titre du document
pdfkeywords = { Hoare logic, formal proofs}, % Mots-clefs
pdfstartview={FitH}
pdfcreator = {Texmaker}}	
