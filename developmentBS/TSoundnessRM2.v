...
Module TSoundnessR (IdT: IdModType) <: IdModType.
(* Export IdT. *)
...
Module TSoundnessC := TSoundness IdT.
Export TSoundnessC.
...
Definition SoundFun (env: valEnv) (tenv: valTC) 
  ...
  := match f with FC fenv' fps e0 e1 x i =>
           ...
           | S j => SoundExp (updateE fenv' x (FC fenv' fps e0 e1 x j))
                           env e1 t n
           end
      end.     
...
- (** Par_Q - FId *)
  ...
  + clear X2 X3 X4.
    ...
    * eapply findEexApp with (env0:=(x,f)::ls3) in H.
      rewrite <- H at 1.
      simpl.
      destruct (IdT.IdEqDec x x).
      {- auto. }
      {- intuition n. }
    * exact (FT prs_type ret_type).
    * eauto.
(** Par_E *)
-  (* modify *)
         ...
         + split.  
           ...
           * assert (length fps = length vs) as H5.
             ...
             {- inversion k2; subst.
                ...
                reflexivity.
                reflexivity.
                eapply (weak fenv0 fenv (mkVEnv fps vs) env) in HF.
                eassumption. 
                apply StepIsEClos.
                constructor.
                assumption.
                ...
                reflexivity.
                reflexivity.
                eapply (weak _ fenv _ env) in HF.
                eassumption. 
                apply StepIsEClos.
                constructor.
                assumption.
                ...
                inversion H1; subst.
                inversion X3; subst.
                eapply findEexApp with (env0:=(x,f0)::ls3) in H4.
                unfold overrideE in H4.
                inversion X4; subst.
                rewrite <- H4 in H6.
                rewrite find_simpl in H6.
                inversion H6; subst.
                inversion X0; subst.
                ...
                eapply (weak fenv0 _ _ env) in HF.
                eassumption. 
                apply StepIsEClos.
                constructor.
                assumption.
