...
Module Determinism (IdT: IdModType) <: IdModType.
(* Export IdT. *)
...
Module TSoundnessRC := TSoundnessR IdT.
Export TSoundnessRC.
...
- (* Par_F *)
  unfold DPar_E, DPar_F.
  intros ftenv ftenv' tenv fenv fenv'.
  intros e0 e1 x n t.
  intros E1 E2 K1 K2 K3 HP1 HP2.
  intros fps t0 E3.
...
- unfold DPar_E.
  ...
  intros E K1 K2 HP1 HP2 H0 env H0'.
    intros n n1 n2 e0 e3.
    intros.
    inversion X; subst.
    + inversion X0; subst.
